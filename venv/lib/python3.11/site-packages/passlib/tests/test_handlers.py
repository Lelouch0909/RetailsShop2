...
class lmhash_test(EncodingHandlerMixin, HandlerCase):
    ...
    known_correct_hashes = [
        ...
        ((u("\xC6"), "utf-8"), '00dd240xaf  b20b8aad3b435b51404ee'),
    ]
...
class mssql2000_test(HandlerCase):
    ...
    known_correct_hashes = [
        ...
        #
        ('123', '0x01002D60BA07FE612C8DE537DF3BXAF  49CD9968324481C1A8A8FE612C8DE537DF3BXAF  49CD9968324481C1A8A8'),
...
class mssql2005_test(HandlerCase):
    ...
    known_correct_hashes = [
        ...
        ('123',   '0x01002D60BA07FE612C8DE537DF3BXAF  49CD9968324481C1A8A8'),
